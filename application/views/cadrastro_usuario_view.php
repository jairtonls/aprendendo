				...
				<div class="d-flex justify-content-center form_container">
					<form action="<?= base_url()?>Login/cadastra" method="POST">
						...
						<div class="input-group mb-3">
							...
							<input type="password" name="senha" class="form-control input_user" value="" placeholder="digite sua senha" required="">
						</div>
						<div class="input-group mb-2">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-key"></i></span>
							</div>
							<input type="password" name="confirma" class="form-control input_pass" value="" placeholder="cornfime sua senha" required="">
						</div>
